...
export const Navbar = () => {
  ...
  return (
    <div className="navbar">
      ...
      <div className="menu">
        <div
          className={`navbar-menu-icon ${open ? "change" : ""}`}
          onClick={toggleMenu}
        >
        ...
        <ul className={`navbar-menu ${open ? "animate" : ""}`}>
          <li>
            <a href="#aboutId" onClick={toggleMenu}>
              About
            </a>
          </li>
          <li>
            <a href="#skillId" onClick={toggleMenu}>
              Skills
            </a>
          </li>
          <li>
            <a href="#projectId" onClick={toggleMenu}>
              Projects
            </a>
          </li>
          <li>
            <a href="#contactId" onClick={toggleMenu}>
              Contact
            </a>
          </li>
        </ul>
